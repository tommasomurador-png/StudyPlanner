...
# 📚 Study Planner
### *Il taccuino digitale intelligente per la gestione dello studio e delle verifiche*
...
- **🔥 Serie di Fuoco & XP:** Tieni traccia della tua costanza giornaliera e sblocca gradi accademici (da Matricola a Einstein) completando i task.
...
In alternativa, puoi installare Study Planner direttamente sul tuo smartphone senza passare dagli store:
1. Apri il link del progetto da Chrome o Safari: **[Clicca qui per aprirlo](https://tommasomurador-png.github.io/StudyPlanner/)**
2. Tocca il menu del browser (i tre puntini in alto a destra su Android o il tasto Condividi su iPhone).
3. Seleziona **"Aggiungi a schermata Home"** o **"Installa app"**.
4. Avrai la tua app dedicata con icona sul telefono che funziona anche offline!

---

## 🛠️ Tecnologie Utilizzate

- **HTML5 & CSS3** (Design minimale, responsive e moderno)
- **JavaScript Vanilla** (Logica di pianificazione e salvataggio locale con `localStorage`)
